...
data_sample = PandasParameterType(pd.DataFrame({"I m not gonna pay this bill this is to much my average bill use to come around 1500 and now u sending me this every month my consumption was same then how come it will increase the bill": pd.Series(["example_value"], dtype="object")}))
